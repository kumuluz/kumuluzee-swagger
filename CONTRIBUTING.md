# Contributing to KumuluzEE Swagger

♥ [KumuluzEE Swagger](https://github.com/kumuluz/kumuluzee-swagger) and want to get involved?
...
**[File a bug report](https://github.com/kumuluz/kumuluzee-swagger/issues/)**
...
1. [Fork](http://help.github.com/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/kumuluzee-swagger.git
   # Navigate to the newly cloned directory
   cd kumuluzee-swagger
   # Assigns the original repo to a remote called "upstream"
   git remote add upstream https://github.com/kumuluz/kumuluzee-swagger.git
   ```
